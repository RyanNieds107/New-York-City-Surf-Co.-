          ...
          <div className="bg-white border-2 border-black p-6 sm:p-8 md:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-2.5 sm:space-y-3">
              ...
              <Button
                type="submit"
                disabled={sendMagicLinkMutation.isPending}
                className="w-full bg-black text-white hover:bg-gray-800 border-2 border-black rounded-none uppercase tracking-wide font-bold py-5 text-sm sm:text-base mt-2 sm:mt-3"
                style={{ fontFamily: "'JetBrains Mono', monospace" }}
              >
