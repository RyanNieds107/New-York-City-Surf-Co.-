                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="grid md:grid-cols-3 gap-2 sm:gap-3">
                    ...
                    <div className="bg-white border-2 border-black p-2 sm:p-3">
                      ...
                      <p className="text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>~$15/day pass or seasonal permit required.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white border-2 border-black">
          ...
          <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-black border-b-2 border-black">
            ...
            <div className="p-3 sm:p-6">
              ...
              <h4 className="text-lg sm:text-xl font-black text-black uppercase mb-2" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>THE STRESS-FREE STRIKE</h4>
              ...
              <div className="space-y-2" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
                <div className="flex gap-2">
                  ...
                  <span className="text-xs sm:text-sm text-gray-800">Penn Station, Grand Central, or Atlantic Terminal</span>
                </div>
                <div className="flex gap-2">
                  ...
                  <span className="text-xs sm:text-sm text-gray-800">~50 minutes. Beats Belt Parkway traffic every time.</span>
                </div>
                <div className="flex gap-2">
                  ...
                  <span className="text-xs sm:text-sm text-gray-800">Few blocks from station to boardwalk. Straight shot to sand.</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-3 sm:p-6">
              ...
              <h4 className="text-lg sm:text-xl font-black text-black uppercase mb-2" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>THE PARKING PUZZLE</h4>
              <p className="text-xs sm:text-sm text-gray-700 mb-3 sm:mb-4 leading-relaxed" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
              ...
              <div className="space-y-2" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
                <div className="flex gap-2">
                  ...
                  <span className="text-xs sm:text-sm text-gray-800">Street parking near beach is residents-only. Enforcement is aggressive.</span>
                </div>
                <div className="flex gap-2">
                  ...
                  <span className="text-xs sm:text-sm text-gray-800">Municipal lots fill by 8 AM in summer.</span>
                </div>
                <div className="flex gap-2">
                  ...
                  <span className="text-xs sm:text-sm text-gray-800">Not doing dawn patrol? Take the train.</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-3 sm:p-6 bg-amber-50">
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-black flex items-center justify-center shrink-0">
                <span className="text-white font-black text-lg sm:text-xl" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>$</span>
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <h4 className="text-lg sm:text-xl font-black text-black uppercase" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>THE "HIDDEN" COST</h4>
                  <span className="text-[10px] font-medium tracking-widest bg-black text-white px-2 py-0.5 shrink-0" style={{ fontFamily: "'JetBrains Mono', monospace" }}>BEACH PASS</span>
                </div>
                <p className="text-xs sm:text-sm text-gray-700 mb-3 leading-relaxed" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
                  The biggest shift for Rockaway locals: Long Beach is "pay-to-play" during the season.
                </p>
                <div className="grid md:grid-cols-3 gap-2 sm:gap-4" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
                  <div>
                    ...
                    <span className="text-xs sm:text-sm text-gray-800">Memorial Day – Labor Day: ~$15/day for non-residents</span>
                  </div>
                  <div>
                    ...
                    <span className="text-xs sm:text-sm text-gray-800">Checked strictly at every entrance during lifeguard hours</span>
                  </div>
                  <div>
                    ...
                    <span className="text-xs sm:text-sm text-gray-800">Dawn Patrol before checkers arrive, or post-6 PM after they leave</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="divide-y-2 divide-black">
            ...
            <div>
              <div className="p-3 sm:p-4 border-b-2 border-black">
                ...
                <p className="text-xs sm:text-sm text-gray-600 mt-1 leading-relaxed" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
              ...
              <div className="relative overflow-hidden">
                ...
                {[
                  ...
                  <div
                    key={name}
                    className="absolute flex-col items-center hidden sm:flex"
                ...
                {[
                  ...
                  <div
                    key={`m-${name}`}
                    className="absolute flex flex-col items-center sm:hidden"
                    style={{ left, top: "44%", transform: "translateX(-50%)" }}
                  >
                    <div className="bg-black text-white px-1 py-0.5 whitespace-nowrap" style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "7px", fontWeight: 700 }}>
                      {name}
                    </div>
                    <div className="w-px bg-white" style={{ height: "10px" }} />
            ...
            <div>
              ...
              <div className="grid grid-cols-[auto_1fr] border-b border-gray-200">
                <div className="bg-black px-2 sm:px-3 py-2 flex items-center">
                  <span className="text-[8px] sm:text-[9px] font-bold tracking-widest text-white uppercase writing-mode-vertical" style={{ fontFamily: "'JetBrains Mono', monospace" }}>HIGH PERFORMANCE</span>
                </div>
                <div className="divide-y divide-gray-200">
                  ...
                  <div className="flex items-start gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3">
                    ...
                    <p className="text-xs sm:text-sm text-gray-700 leading-snug" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
                  ...
                  <div className="flex items-start gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs sm:text-sm text-gray-700 leading-snug mb-2" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
              ...
              <div className="grid grid-cols-[auto_1fr]">
                <div className="bg-gray-400 px-2 sm:px-3 py-2 flex items-center">
                  <span className="text-[8px] sm:text-[9px] font-bold tracking-widest text-white uppercase" style={{ fontFamily: "'JetBrains Mono', monospace" }}>MELLOW</span>
                </div>
                <div className="divide-y divide-gray-200">
