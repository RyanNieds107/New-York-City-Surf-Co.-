          ...
          <div className="divide-y-2 divide-black">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="grid md:grid-cols-2 gap-2 sm:gap-3">
                    <div className="bg-white border-2 border-black p-2 sm:p-3">
                      ...
                      <p className="text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>Tropical systems pump SE swell. Cold fronts provide N/NW grooming winds.</p>
                    </div>
                    <div className="bg-white border-2 border-black p-2 sm:p-3">
                      ...
                      <p className="text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>Cape Verde storm riding Bermuda High, recurving north. Bill '09, Larry '21, Lee '23.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="p-3 sm:p-6 bg-amber-50">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1 sm:mb-2">
                    <h4 className="text-lg sm:text-2xl font-black text-black uppercase" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>SECONDARY SEASON</h4>
                  ...
                  <div className="grid md:grid-cols-2 gap-2 sm:gap-3">
                    <div className="bg-white border-2 border-black p-2 sm:p-3">
                      ...
                      <p className="text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>NJ often gets the better end as westerly winds prevail.</p>
                    </div>
                    <div className="bg-white border-2 border-black p-2 sm:p-3">
                      ...
                      <p className="text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>Wait for the "backside"—N/NW winds after the low passes east.</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="grid md:grid-cols-3 gap-2 sm:gap-3">
                    <div className="bg-white border-2 border-black p-2 sm:p-3">
                      ...
                      <p className="text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>Dawn patrol before 8 AM when winds are friendliest.</p>
                    </div>
                    <div className="bg-white border-2 border-black p-2 sm:p-3">
                      ...
                      <p className="text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>High-traffic. Lifeguard restrictions 9 AM – 6 PM.</p>
                    </div>
                    <div className="bg-white border-2 border-black p-2 sm:p-3">
                      ...
                      <p className="text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>Beach access is free. No tags, no passes.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="bg-gray-50 border-2 border-black p-3 sm:p-4">
                <h4 className="text-base sm:text-lg font-black text-black uppercase mb-2" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>SURF BREAK FORMATION</h4>
            ...
            <div className="space-y-2">
              <img
                ...
                style={{ maxHeight: 'min(400px, 60vw)' }}
              />
            ...
            {/* Period Guide */}
            <div>
              <h4 className="text-lg sm:text-xl font-black text-black uppercase mb-3 sm:mb-4" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>PERIOD GUIDE</h4>
              <div className="space-y-3 sm:space-y-4">
                <div className="bg-emerald-50 border-2 border-black p-3 sm:p-4">
                ...
                <div className="bg-amber-50 border-2 border-black p-3 sm:p-4">
                  ...
                  <p className="text-xs sm:text-sm text-gray-800 mb-2" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
            ...
            {/* Wind Guide */}
            <div>
              <h4 className="text-lg sm:text-xl font-black text-black uppercase mb-3 sm:mb-4" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>WIND GUIDE</h4>
              <div className="space-y-2 sm:space-y-3">
                <div className="bg-white border-2 border-black p-3 sm:p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Wind className="w-4 h-4 text-black shrink-0" />
                    <span className="text-xs sm:text-sm font-bold text-black" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>NNW (North-Northwest)</span>
                    <span className="text-[10px] font-medium tracking-widest bg-emerald-600 text-white px-2 py-0.5 shrink-0" style={{ fontFamily: "'JetBrains Mono', monospace" }}>DEAD OFFSHORE</span>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>Best wind direction for Rockaway.</p>
                </div>
                <div className="bg-white border-2 border-black p-3 sm:p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Wind className="w-4 h-4 text-black shrink-0" />
                    <span className="text-xs sm:text-sm font-bold text-black" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>N (North)</span>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>Can be a little too North, but still works.</p>
                </div>
                <div className="bg-white border-2 border-black p-3 sm:p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Wind className="w-4 h-4 text-black shrink-0" />
                    <span className="text-xs sm:text-sm font-bold text-black" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>W (West)</span>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-800 mb-2" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>Even west works at Rockaway.</p>
                  <p className="text-xs text-gray-600 italic" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
            ...
            {/* Tide Guide */}
            <div>
              <h4 className="text-lg sm:text-xl font-black text-black uppercase mb-3 sm:mb-4" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>TIDE GUIDE</h4>
              <div className="space-y-2 sm:space-y-3">
                <div className="bg-red-50 border-2 border-black p-3 sm:p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Droplet className="w-4 h-4 text-black shrink-0" />
                    <span className="text-xs sm:text-sm font-bold text-black" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>Low Tide</span>
                    <span className="text-[10px] font-medium tracking-widest bg-red-500 text-white px-2 py-0.5 shrink-0" style={{ fontFamily: "'JetBrains Mono', monospace" }}>AVOID</span>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-800 italic" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
                ...
                <div className="bg-emerald-50 border-2 border-black p-3 sm:p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Droplet className="w-4 h-4 text-black shrink-0" />
                    <span className="text-xs sm:text-sm font-bold text-black" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>Mid-High Tide</span>
                    <span className="text-[10px] font-medium tracking-widest bg-emerald-600 text-white px-2 py-0.5 shrink-0" style={{ fontFamily: "'JetBrains Mono', monospace" }}>PREFERRED</span>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
                ...
                <div className="bg-emerald-50 border-2 border-black p-3 sm:p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Droplet className="w-4 h-4 text-black shrink-0" />
                    <span className="text-xs sm:text-sm font-bold text-black" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>High Tide</span>
                    <span className="text-[10px] font-medium tracking-widest bg-emerald-600 text-white px-2 py-0.5 shrink-0" style={{ fontFamily: "'JetBrains Mono', monospace" }}>GREAT</span>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-800 mb-2" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
                ...
                <div className="bg-blue-50 border-2 border-black p-3 sm:p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Droplet className="w-4 h-4 text-black shrink-0" />
                    <span className="text-xs sm:text-sm font-bold text-black" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>Wind Swell + Incoming Tide</span>
                    <span className="text-[10px] font-medium tracking-widest bg-blue-500 text-white px-2 py-0.5 shrink-0" style={{ fontFamily: "'JetBrains Mono', monospace" }}>PRO TIP</span>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
            ...
            {/* Reading Conditions */}
            <div>
              <h4 className="text-lg sm:text-xl font-black text-black uppercase mb-3 sm:mb-4" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>READING CONDITIONS</h4>
              <div className="bg-gray-50 border-2 border-black p-3 sm:p-4 space-y-3">
                <p className="text-xs sm:text-sm text-gray-800 italic" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
      ...
      {activeTab === "surf-culture" && (
        <SpotInfoCard title="Surf Culture">
          <div className="space-y-5 sm:space-y-6">
            <div>
              <h4 className="text-lg font-black text-black uppercase mb-2 sm:mb-3" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>WHO IT'S FOR</h4>
            ...
            <div>
              <h4 className="text-lg font-black text-black uppercase mb-2 sm:mb-3" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>HAZARDS</h4>
              <div className="space-y-3">
                <div className="bg-white border-2 border-black p-3 sm:p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <AlertCircle className="w-4 h-4 text-black shrink-0" />
                    <span className="text-xs sm:text-sm font-bold text-black" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>General Hazards</span>
                  </div>
                  <ul className="text-xs sm:text-sm text-gray-800 space-y-1" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
                ...
                <div className="bg-red-50 border-2 border-red-500 p-3 sm:p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs sm:text-sm font-bold text-black" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>Seasonal Issues</span>
                  </div>
                  <div className="space-y-2 text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
            ...
            <div>
              <h4 className="text-lg font-black text-black uppercase mb-2 sm:mb-3" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>OFF-SEASON RESTRICTIONS</h4>
              <div className="bg-amber-50 border-2 border-black p-3 sm:p-4">
                <div className="flex items-center gap-2 mb-2">
                  <Clock className="w-4 h-4 text-black shrink-0" />
                  <span className="text-xs sm:text-sm font-bold text-black" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>Summer Hours</span>
            ...
            <div>
              <h4 className="text-lg font-black text-black uppercase mb-2 sm:mb-3" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>STREET/BREAK GUIDE</h4>
              <div className="space-y-3">
                <div className="bg-white border-2 border-black p-3 sm:p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <MapPin className="w-4 h-4 text-black shrink-0" />
                    <span className="text-xs sm:text-sm font-bold text-black" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>90th Street</span>
                ...
                <div className="bg-white border-2 border-black p-3 sm:p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <MapPin className="w-4 h-4 text-black shrink-0" />
                    <span className="text-xs sm:text-sm font-bold text-black" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>90-98th Street</span>
                ...
                <div className="bg-white border-2 border-black p-3 sm:p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <MapPin className="w-4 h-4 text-black shrink-0" />
                    <span className="text-xs sm:text-sm font-bold text-black" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>70s Street</span>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
                ...
                <div className="bg-white border-2 border-black p-3 sm:p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <MapPin className="w-4 h-4 text-black shrink-0" />
                    <span className="text-xs sm:text-sm font-bold text-black" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>60s-70s Street</span>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
                ...
                <div className="bg-gray-50 border-2 border-black p-3 sm:p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <MapPin className="w-4 h-4 text-black shrink-0" />
                    <span className="text-xs sm:text-sm font-bold text-black" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>Uptown</span>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
            ...
            <div>
              <h4 className="text-lg font-black text-black uppercase mb-2 sm:mb-3" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>WAVE DIRECTION</h4>
              <div className="bg-gray-50 border-2 border-black p-3 sm:p-4 space-y-2">
                <p className="text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
            ...
            <div>
              <h4 className="text-lg font-black text-black uppercase mb-2 sm:mb-3" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>VIBE</h4>
              <div className="bg-emerald-50 border-2 border-black p-3 sm:p-4 space-y-2">
                <p className="text-xs sm:text-sm text-gray-800" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
        ...
        <div className="bg-white border-2 border-black">
          ...
          <div className="grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-black border-b-2 border-black">
            ...
            <div className="p-3 sm:p-6">
              <div className="flex items-center gap-2 mb-3">
                <div className="w-8 h-8 bg-[#0039A6] flex items-center justify-center shrink-0">
              ...
              <h4 className="text-lg sm:text-xl font-black text-black uppercase mb-2" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>THE A TRAIN & SHUTTLE</h4>
              ...
              <div className="space-y-2 text-sm" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
                <div className="flex gap-2">
                  ...
                  <span className="text-xs sm:text-sm text-gray-800">Far Rockaway-bound A to Broad Channel, transfer to S shuttle</span>
                </div>
                <div className="flex gap-2">
                  ...
                  <span className="text-xs sm:text-sm text-gray-800">Beach 90th (the scene), 105th (quieter), 116th (end of line)</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-3 sm:p-6">
              ...
              <h4 className="text-lg sm:text-xl font-black text-black uppercase mb-2" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>NYC FERRY</h4>
              <p className="text-xs sm:text-sm text-gray-700 mb-3 sm:mb-4 leading-relaxed" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
              ...
              <div className="space-y-2 text-sm" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
                <div className="flex gap-2">
                  ...
                  <span className="text-xs sm:text-sm text-gray-800">Wall St./Pier 11 or Sunset Park (Brooklyn)</span>
                </div>
                <div className="flex gap-2">
                  ...
                  <span className="text-xs sm:text-sm text-gray-800">Beach 108th St. 10-min walk to the 90s</span>
                </div>
                <div className="flex gap-2">
                  ...
                  <span className="text-xs sm:text-sm text-gray-800">Bar on board. Makes the ride back even better.</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-3 sm:p-6">
              ...
              <h4 className="text-lg sm:text-xl font-black text-black uppercase mb-2" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>CAR & PARKING</h4>
              <p className="text-xs sm:text-sm text-gray-700 mb-3 sm:mb-4 leading-relaxed" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
              ...
              <div className="space-y-2 text-sm" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
                <div className="flex gap-2">
                  ...
                  <span className="text-xs sm:text-sm text-gray-800">Summer: parked by 7:30 AM or you're circling blocks</span>
                </div>
                <div className="flex gap-2">
                  ...
                  <span className="text-xs sm:text-sm text-gray-800">Street parking free but limited near breaks</span>
                </div>
                <div className="flex gap-2">
                  ...
                  <span className="text-xs sm:text-sm text-gray-800">Beach access is free. No tags, no passes.</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-3 sm:p-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-sm min-w-[400px]" style={{ fontFamily: "'Inter', 'Roboto', sans-serif" }}>
                <thead>
                  <tr>
                    <th className="border-2 border-black bg-black text-white px-2 sm:px-4 py-2 sm:py-3 text-left font-black uppercase tracking-wide text-[10px] sm:text-xs whitespace-nowrap" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>METHOD</th>
                    <th className="border-2 border-black bg-black text-white px-2 sm:px-4 py-2 sm:py-3 text-left font-black uppercase tracking-wide text-[10px] sm:text-xs whitespace-nowrap" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>BEST FOR</th>
                    <th className="border-2 border-black bg-black text-white px-2 sm:px-4 py-2 sm:py-3 text-left font-black uppercase tracking-wide text-[10px] sm:text-xs whitespace-nowrap" style={{ fontFamily: "'Bebas Neue', 'Oswald', sans-serif" }}>THE TRADE-OFF</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border-2 border-black px-2 sm:px-4 py-2 sm:py-3 font-bold text-black text-xs sm:text-sm">A Train</td>
                    <td className="border-2 border-black px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm">The car-less surfer</td>
                    <td className="border-2 border-black px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm">A long, gritty commute</td>
                  </tr>
                  <tr>
                    <td className="border-2 border-black px-2 sm:px-4 py-2 sm:py-3 font-bold text-black text-xs sm:text-sm">Ferry</td>
                    <td className="border-2 border-black px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm">Scenic views & vibes</td>
                    <td className="border-2 border-black px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm">Long lines in summer heat</td>
                  </tr>
                  <tr>
                    <td className="border-2 border-black px-2 sm:px-4 py-2 sm:py-3 font-bold text-black text-xs sm:text-sm">Car</td>
                    <td className="border-2 border-black px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm">Winter / Dawn Patrol</td>
                    <td className="border-2 border-black px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm">Summer parking is a blood sport</td>
                  </tr>
                </tbody>
              </table>
            </div>
